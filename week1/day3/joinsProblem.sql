...
select e.name,e.department,p.proj_name from Employees e inner join Projects p on e.emp_id=p.emp_id; 
select e.name,e.department,p.proj_name from Employees e left join Projects p on e.emp_id=p.emp_id; 
select e.name,e.department,p.proj_name from Employees e right join Projects p on e.emp_id=p.emp_id; 
